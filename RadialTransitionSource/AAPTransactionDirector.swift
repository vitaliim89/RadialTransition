...
class AAPTransactionDirector: NSObject,UIViewControllerAnimatedTransitioning,UINavigationControllerDelegate,UIViewControllerInteractiveTransitioning {
    ...
    *
    */
    lazy var animationBlock: ((_ transactionContext: UIViewControllerContextTransitioning,
                              _ animationTime: CGFloat,
                              _ transitionCompletion: (@escaping()->Void))->Void)? = nil
    /**
    * interactive update block.Use transactionContext to get all needed views.updating after percent changing
    *
    */
    lazy var interactiveUpdateBlock:((_ transactionContext:UIViewControllerContextTransitioning,
                                      _ percent: CGFloat)->Void)? = nil
...
//MARK: Interactive transaction ending
    ...
    */
    ...
    @objc func updateFinishAnimation(){
    ...
    @objc func updateCancelAnimation(){
...
//MARK: animation transaction delegate
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        _ = transitionContext.viewController(forKey: .from)?.view
        _ = transitionContext.viewController(forKey: .to)?.view
        
        self.animationBlock?(self._context!, self.duration!, {
